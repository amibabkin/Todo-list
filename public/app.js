...
function printTodo(_a) {
    ...
    li.innerHTML = "<span>".concat(title, "</span> <i>by</i> <b>").concat(getUserName(userId), "</b>");
...
// Event logic
function initApp() {
    Promise.all([getAllUsers(), getAllTodos()]).then(function (values) {
        users = values[0], todos = values[1];
